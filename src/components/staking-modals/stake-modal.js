...
export default function StakeModal({ isOpen = false, onClose = () => null }) {
  return (
    <>
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-cdark-500  p-6 py-10 text-left align-middle shadow-xl transition-all relative">
                  ...
                  >
                    <div className="text-center">
                      <h3 className="font-semibold text-lg">Stake</h3>
                    </div>
                  </Dialog.Title>
                  ...
                  <div className="mt-10 flex gap-5">
                    <button className="rounded-md bg-cpink-100 w-[50%] hover:bg-pink-600 transition-all">
                      <span className="inline-block py-1 px-5 text-lg font-medium">
                        Stake
                      </span>
                    </button>
                    <button className="rounded-md bg-transparent w-[50%] border border-cpink-100 hover:border-pink-600 transition-all">
                      <span className="inline-block py-1 px-5 text-lg font-medium">
                        Get BTC
                      </span>
                    </button>
